  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <ratingselect :select-type="selectType" :only-content="onlyContent"
                  :desc="desc" :ratings="ratings" @selectedRatingtype="select" @contentToggle="contentonly"></ratingselect>
      <div class="rating-wrapper">
        <ul>
          <li v-show="needShow(rating.rateType,rating.text)" v-for="(rating,index) in ratings" v-bind:key="index" class="rating-item">
            <div class="avatar">
