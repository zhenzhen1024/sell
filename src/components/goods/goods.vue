...
<div class="goods">
  <div class="menu-wrapper" ref="menuWrapper">
    <ul>
      <li v-for="(item, index) in goods" class="menu-item" v-bind:key="item.id"
  ...
  <div class="foods-wrapper" ref="foodsWrapper">
    <ul >
      <li v-for="item in goods" class="food-list food-list-hook" v-bind:key="item.id">
        <h1 class="title">{{ item.name}}</h1>
        <ul>
          <li @click="selectFood(food, $event)" v-for="food in item.foods" class="food-item border-1px" v-bind:key="food.id">
            <div class="icon">
  ...
  <food class="food" :food="selectedFood" ref="food"  v-on:cartAdd="_drop"></food>
</div>
</template>
